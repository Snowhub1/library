...
snow = {
    ...
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(20, 30, 45)),
...
["Color Theme"] = Color3.fromRGB(160, 220, 255),
["Color Text"] = Color3.fromRGB(255, 255, 255),
["Color Dark Text"] = Color3.fromRGB(130, 160, 180)
...
local function SpawnCyberpunkSystem()
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "Close",
			Text = "Are you sure you've closed the SnowX hub ",
			Options = {
				{"Confirm", function()
					ScreenGui:Destroy()
				end},
